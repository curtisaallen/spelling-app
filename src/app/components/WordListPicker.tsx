...
export default function WordListPicker() {
  ...
  return (
    <section className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 md:p-8 text-slate-800 mt-5 mb-5">
      <h2 className="text-center text-2xl font-bold mb-5">Word List:</h2>
